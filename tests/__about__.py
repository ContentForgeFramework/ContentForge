...
# for the ContentForge software distribution.
#
# @filename   __about__.py
# @path       tests\__about__.py
...
#
# @version    git
# @record     2025/03/16 16:02 <Content Forge> Create file.
#             2025/03/16 16:02 <Content Forge> Update header comment.
