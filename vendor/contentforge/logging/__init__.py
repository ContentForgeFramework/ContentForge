...
#
# This package contains logging manager for the framework.
# 
# @filename   __init__.py
# @path       vendor\contentforge\logging\__init__.py
...
# @time       2024/12/8 00:40
# 
# @version    git
# @record     2024/12/8 0:41 <Carl Chen> Create file.
#             2024/12/8 0:41 <Carl Chen> Update header comment.
