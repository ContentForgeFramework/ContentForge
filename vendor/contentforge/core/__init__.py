...
#
# This package contains core classes for the framework.
# 
# @filename   __init__.py
# @path       vendor\contentforge\core\__init__.py
...
# 
# @version    git
# @record     2024/12/8 0:40 <Carl Chen> Create file.
#             2024/12/8 0:40 <Carl Chen> Update header comment.
